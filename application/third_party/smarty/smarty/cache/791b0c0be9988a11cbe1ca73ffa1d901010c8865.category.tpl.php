...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_558a854c2315f2_11519021',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_558a854c2315f2_11519021')) {
function content_558a854c2315f2_11519021 ($_smarty_tpl) {
?>
<!DOCTYPE html>
    ...
    <ul class="mainNav">
        ...
        <li class="active">
            ...
            <ul>
                ...
                <li><a href="/paneladmin/page/category" class="active">Kategoriler </a></li>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control input-sm" name="parent">
                            <option value="0">Hiçbiri</option>
	                       																		...
	                       																		<option value="2"> serkan erdinç</option>
                ...
                <div class="table-responsive ls-table">
                    <table class="table table-bordered table-bottomless" id="">
                        ...
                        <tbody>
		                            ...
		                            <td>serkan erdinç haakkında kategoriler</td>
		                            <td>serkan-erdinc</td>
		                            <td>0</td>
		                        </tr>
										                        		                        																<tr id="cat3" >
		                            <td>3</td>
		                            <td onmouseover="CatEdit(3)">
		                            	--| HK
		                            ...
		                            <td>0</td>
		                        															...
		                        															<tr id="cat6" >
		                            <td>6</td>
		                            <td onmouseover="CatEdit(6)">
		                            	 deneme
		                            	<div class="row-action6">
		                            		<span><a title="Düzenle" href="/paneladmin/page/categoryedit"><i class="fa fa-edit"></i></a></span>
		                            		<span><a title="Sil" href="/paneladmin/page/categorydelete"><i class="fa fa-times-circle-o"></i></a></span>
		                            	</div>
		                            </td>
...
?><?php /* smarty_template_function_termsOpt_29168558a854b7a3c35_60703641 */
...
<?php /* smarty_template_function_terms_29168558a854b7a3c35_60703641 */
