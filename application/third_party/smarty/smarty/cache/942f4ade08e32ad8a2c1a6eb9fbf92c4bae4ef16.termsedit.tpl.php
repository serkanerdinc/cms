...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_558a9bc41a4b94_90778382',
  'cache_lifetime' => 120,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_558a9bc41a4b94_90778382')) {
function content_558a9bc41a4b94_90778382 ($_smarty_tpl) {
?>
<!DOCTYPE html>
            ...
            <div class="panel-body">
                <form role="form" class="ls_form" method="post">
                    <div class="form-group">
                        <label>Adı</label>
                        <input type="text" placeholder="Adı" value="face" name="name" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Slug</label>
                        <input type="text" placeholder="Slug" name="slug" value="face" class="form-control">
                    </div>
                                        <div class="form-group">
                        ...
                        <select class="form-control input-sm" name="parent">
                            <option  value="0">Hiçbiri</option>
	                       																		...
	                       																		<option   value="2"> serkan erdinç kategori</option>
			                        													                        																		...
			                        													                        																		<option  selected value="4">=>=> dragon</option>
			                        													                        																		<option disabled  value="5">=>=>=> face</option>
                        ...
                        <textarea class="form-control" id="description" name="description" rows="5"  placeholder="Description">face dragon,asdasd</textarea>
                    </div>
                    <div class="form-group">
                        <label>Keywords</label>
                        <textarea class="form-control" id="keywords" name="keywords" rows="5"  placeholder="Keywords">face dragon,asdasd</textarea>
                    </div>
                    <div class="form-group">
...
?><?php /* smarty_template_function_termsOpt_20177558a9bc38d4739_42167671 */
