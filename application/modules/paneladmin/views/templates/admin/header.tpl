                    ...
                    <div class="dropdown-menu right top-dropDown-1">
                        ...
                        <ul class="goal-item">
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="/admin/assets/images/userimage/avatar3-80.png" alt="user image" />
                                    </div>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="/admin/assets/images/userimage/avatar2-80.png" alt="user image" />
                                    </div>
                                    <div class="goal-content">
                                        PSD Designe
                                        <div class="progress progress-striped active">
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="/admin/assets/images/userimage/avatar1-80.png" alt="user image" />
                                    </div>
                                    <div class="goal-content">
                                        Wordpress PLugin
                                        <div class="progress progress-striped active">
...
<section id="main-container">
    ...
    <section id="left-navigation">
        ...
        <div class="user-image">
            <img src="/admin/assets/images/userimage/avatar2-80.png" alt=""/>
